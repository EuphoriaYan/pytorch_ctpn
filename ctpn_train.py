...
from data import VOCDataset, FakepagesDataset
...
def get_arguments():
    ...
    parser.add_argument('--image_dir', type=str, default=config.img_dir)
    parser.add_argument('--labels_dir', type=str, default=config.xml_dir)
    parser.add_argument('--pretrained_weights', type=str, default=pre_weights)
